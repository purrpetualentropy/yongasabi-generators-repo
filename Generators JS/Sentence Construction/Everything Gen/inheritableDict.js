export const inheritableDict = [
    { type: "person", // this type attribute is never read
        ...
        bannedTense: "none",
        args: {
            vocative: [0, 1, 2, 3, 4, 4.1, 4.2, 5, 6, 7, 8, 9, 10],
            genitive: true,
    ...
    { type: "lizard",
      index: 1,
      legalVTypes: [0, 2, 3, 4, 4.1, 4.2, 6, 8, 9],
      legalAlters: ["adjective", "negation"],
      temporalTense: "any",
      nonTemporalTenses: true,
      bannedTense: "none",
    ...
    {  type: "timing",
        ...
        legalVTypes: [2, 3, 4, 4.1, 4.2, 5, 6, 7, 8, 9, 10],
        legalAlters: ["negation"],
        args: {
            vocative: [-1],
            genitive: [-1],
            subject: [-1],
            timing: [2, 3, 4, 4.1, 4.2, 5, 6, 7, 8, 9, 10],
            locative: [-1],
            ablative: [-1],
            instrumental: [-1],
            indirobj: [-1],
    ...
    { type: "position words",
    index: 8,
        legalVTypes: [0, 2, 3, 4, 4.1, 4.2, 5, 6, 7, 8, 9, 10],
